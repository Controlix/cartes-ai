...
const GameHistory: React.FC<GameHistoryProps> = ({ rounds }) => {
  ...
  if (rounds.length === 0) {
    return (
      <div className="flex-1 flex items-center justify-center p-8 text-gray-400 italic bg-white/50 rounded-xl border-2 border-dashed border-gray-100">
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
      <div className="grid grid-cols-3 bg-gray-50 border-b border-gray-100 text-xs font-bold uppercase tracking-wider text-gray-500 py-3 px-4">
        ...
        <div className="text-center">{translations.history.team1Header}</div>
        <div className="text-right">{translations.history.team2Header}</div>
      </div>
